...
<link rel="stylesheet" href="../style/jquery.scrollintro.css">
...
<div class="wrapper">
	...
	<div class="scroll-content" id="content1">
		...
		<div class="content100-block animate-block">
			<img src="../img/triworks_abstract31.jpg" class="animate-block full-image" id="click2next" />
	...
	<div class="scroll-content" id="content2" data-easein="bounceInUp">
		...
		<div class="animate-block content240-block">
			<img src="../img/icons/clock.png" class="image240-block" />
			<p class="animate-block caption">
			随时可用的排练室，豪华的排练室在西电可不多哟
			</p>
		</div>
		<div class="animate-block content240-block">
			<img src="../img/icons/gadgets.png" class="image240-block" />
			<p class="animate-block caption">牛x的音响设备，我们可是有定制的电子管音箱啊</p>
		</div>
		<div class="animate-block content240-block">
			<img src="../img/icons/control.png" class="image240-block" />
			<p class="animate-block caption">大小演出机会，让你技术不断精进</p>
		</div>
		<div class="animate-block content240-block">
			<img src="../img/icons/music.png" class="image240-block" />
	...
	<div class="scroll-content" id="content3" data-easein="rollIn">
		...
		<div class="animate-block content240-block">
			<img src="../img/icons/homegroup.png" class="image240-block" />
			<p class="animate-block caption">
			 认识同样热爱音乐的朋友</p>
		</div>
		<div class="animate-block content240-block">
			<img src="../img/icons/finder.png" class="image240-block" />
			<p class="animate-block caption">以优惠的价格买到演出门票</p>
		</div>
		<div class="animate-block content240-block">
			<img src="../img/icons/connect.png" class="image240-block" />
